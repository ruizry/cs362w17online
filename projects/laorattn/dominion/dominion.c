...
int cardEffect_adventurer(int drawntreasure, int currentPlayer, struct gameState *state, int handPos, int cardDrawn, int* temphand, int z){
...
int cardEffect_council_room(int i, int currentPlayer, struct gameState *state, int handPos){
      //+4 Cards
      for (i = 0; i < 4; i++)
	{
	  drawCard(currentPlayer, state);
...
int cardEffect_great_hall(int i, int currentPlayer, struct gameState *state, int handPos){
      //+1 Card
      drawCard(currentPlayer, state);
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    {
    case adventurer:
		cardEffect_adventurer(drawntreasure, currentPlayer, state, handPos, cardDrawn, temphand, z);
    
			
    case council_room:
      //+4 Cards
		cardEffect_council_room(i, currentPlayer, state, handPos);
    ...
    case smithy:
		cardEffect_smithy(i, currentPlayer, state, handPos);
    ...
    case great_hall:
	  cardEffect_great_hall(i,currentPlayer, state, handPos);
