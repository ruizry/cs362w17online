...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    ...
    case adventurer:
      ...
      callAdventurer(drawntreasure,state,currentPlayer,temphand,z, cardDrawn);
			
    case council_room:
    
      callCouncilRoom(currentPlayer,state,handPos);
    ...
    case embargo: 
      ...
      callEmbargo(state,currentPlayer,handPos,choice1);
...
// Refactored methods from the card effects switch statement

int callAdventurer(int drawntreasure, struct gameState *state, int currentPlayer,int temphand[], int z, int cardDrawn)
{
...
//End refactored methods from the card effects switch statement
